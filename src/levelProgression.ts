...
export const LEVEL_PROGRESSION_TABLE: LevelInfo[] = [
  { level: 1, title: 'Stop Aprendiz', xpRequired: 0, icon: '🌱', rewardDescription: 'Moldura Clássica de Madeira', cosmeticId: 'frame_padrao_madeira' },
  ...
  { level: 5, title: 'Stop Veterano', xpRequired: 400, icon: '🎖️', rewardDescription: 'Moldura Ouro Imperial & Emblema Medalha de Ouro', cosmeticId: 'frame_ouro_radiante' },
  ...
  { level: 7, title: 'Farol da Paz Escolar', xpRequired: 650, icon: '🕯️', rewardDescription: 'Moldura Ninjas do Fogo & Trovão & Título ✦ Farol da Paz ✦', cosmeticId: 'frame_esmeralda_natureza' },
  ...
  { level: 9, title: 'Escudo da Coletividade', xpRequired: 1000, icon: '☁️', rewardDescription: 'Moldura Nuvem Voadora & Aro Místico', cosmeticId: 'frame_safira_oceano' },
  ...
  { level: 11, title: 'Mestre da Desescalada', xpRequired: 1400, icon: '🐉', rewardDescription: 'Moldura Dragão de Gelo & Safiras Ancestrais & Título ✦ Mente Serena ✦', cosmeticId: 'frame_ametista_mistica' },
  { level: 12, title: 'Diplomata da Fraternidade', xpRequired: 1600, icon: '🕊️', rewardDescription: 'Moldura Real Leão Dourado & Ícone Coroa Imperial', cosmeticId: 'frame_cyber_neon' },
  { level: 13, title: 'Stop de Elite', xpRequired: 1800, icon: '🐺', rewardDescription: 'Moldura Asas de Ouro & Ametista Celestial & Ícone Lobo Guardião', cosmeticId: 'frame_rubi_coragem' },
  ...
  { level: 15, title: 'Lorde Stop Honorário', xpRequired: 2250, icon: '⚜️', rewardDescription: 'Moldura Prisma da Diversidade & Título ⚜ Lorde Guardião ⚜', cosmeticId: 'frame_arco_iris_paz' },
