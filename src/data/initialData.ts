...
export const INITIAL_DENUNCIAS: Denuncia[] = [
  {
    ...
    turno: 'Manhã',
    turma_envolvida: '1º Ano B (Ensino Médio)',
    ...
    acoes_mediacao: [
      {
        id: 'med-1',
        autor: 'Coord. Silvana Rocha',
        acao: 'Acolhimento inicial do estudante e registro de prints para notificação dos responsáveis.',
        dataHora: '2026-08-22T14:30:00Z',
  ...
  },
  {
    ...
    papel_denunciante: 'Colega de Sala (Testemunha)',
    frequencia: 'Diariamente',
    is_sos: false,
    acoes_mediacao: [
      {
        id: 'med-2',
        autor: 'Profª. Mediadora Karla',
        acao: 'Roda de conversa restaurativa sobre respeito e comunicação não-violenta em sala.',
        dataHora: '2026-08-21T10:00:00Z',
        categoria: 'Orientação em Sala'
      }
    ]
  },
  {
    ...
    descricao: 'Empurrões repetidos na fila do refeitório com rasgo de caderno e ameaças de agressão física grave se a coordenação souber.',
    data_envio: '2026-08-18T11:00:00Z',
    status: 'Resolvido',
    nivel_gravidade: 'Grave',
    turno: 'Integral',
    turma_envolvida: '3º Ano C',
    papel_denunciante: 'Vítima',
    ...
    acoes_mediacao: [
      {
        ...
        acao: 'Intervenção imediata no intervalo. Os responsáveis de ambas as partes foram convocados.',
        dataHora: '2026-08-18T11:45:00Z',
        categoria: 'Conversa com Responsáveis'
      },
      {
        id: 'med-3b',
        autor: 'Comissão de Mediação',
        acao: 'Termo de compromisso e acompanhamento psicológico continuado. Caso sanado com sucesso.',
        dataHora: '2026-08-19T16:00:00Z',
        categoria: 'Acordo de Convivência'
      }
    ]
  },
  {
  ...
  {
    id: '5',
    protocolo: 'STP-SOS991',
    tipo_violencia: 'Física',
    local_escola: 'Entorno da Escola',
    descricao: 'ALERTA SOS URGENTE: Estudante encurralado na saída do colégio por grupo de veteranos proferindo ofensas e ameaças físicas de espancamento.',
    data_envio: '2026-09-08T17:20:00Z',
    status: 'Em Análise',
    nivel_gravidade: 'Grave',
    turno: 'Tarde',
    turma_envolvida: '1º Ano C',
    papel_denunciante: 'Vítima (Disparo SOS)',
    frequencia: 'Urgência Imediata',
    is_sos: true
  }
];
