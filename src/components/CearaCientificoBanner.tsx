  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-fadeIn">
          ...
          <div className="flex bg-white p-1 rounded-xl border border-purple-200 shadow-sm">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                viewMode === 'banner' ? 'bg-gradient-to-r from-purple-600 to-indigo-600 text-white shadow-xs' : 'text-[#5c546d] hover:text-[#241e33]'
              }`}
            >
              Banner 90x120cm
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                viewMode === 'resumo' ? 'bg-gradient-to-r from-purple-600 to-indigo-600 text-white shadow-xs' : 'text-[#5c546d] hover:text-[#241e33]'
              }`}
            >
              Resumo &amp; Metodologia
            </button>
      ...
      {viewMode === 'banner' ? (
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-white/95 border border-purple-200 shadow-xl space-y-6 text-[#241e33] text-sm leading-relaxed">
          <div className="space-y-2 border-b border-purple-100 pb-4">
            <span className="text-xs font-bold text-purple-700 uppercase tracking-wider bg-purple-50 px-2.5 py-0.5 rounded-full border border-purple-200 inline-block">
              Documento Científico da Pesquisa
            </span>
            <h3 className="font-display text-xl font-bold text-[#241e33]">
          ...
          <div className="space-y-4">
            <h4 className="font-display text-base font-bold text-purple-900">1. Resumo Executivo</h4>
            <p className="text-[#473e57]">
          ...
          <div className="space-y-4">
            <h4 className="font-display text-base font-bold text-purple-900">2. Alinhamento com a Legislação Vigente</h4>
            <p className="text-[#473e57]">
              O projeto fundamenta-se estritamente na <strong className="text-purple-950">Lei Federal nº 13.185/2015</strong> (Programa de Combate à Intimidação Sistemática), na <strong className="text-purple-950">Lei nº 14.811/2024</strong> (Escola Mais Segura e criminalização do bullying/cyberbullying no Código Penal) e no <strong className="text-purple-950">ECA (Lei nº 8.069/1990)</strong>, transformando obrigações legais em ferramentas práticas de cidadania escolar.
            </p>
          </div>
        </div>
      )}
